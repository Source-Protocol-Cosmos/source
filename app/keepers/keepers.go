...
import (
	...
	mintkeeper "github.com/Source-Protocol-Cosmos/source/v3/x/mint/keeper"
	...
	feesharekeeper "github.com/Source-Protocol-Cosmos/source/v3/x/feeshare/keeper"
...
func NewAppKeepers(
	...
	sourcePrefix := sdk.GetConfig().GetBech32AccountAddrPrefix()
	wasmHooks := ibchooks.NewWasmHooks(appKeepers.IBCHooksKeeper, nil, sourcePrefix) // The contract keeper needs to be set later
