...
import (
	...
	apphelpers "github.com/Source-Protocol-Cosmos/source/v3/app/helpers"
	appparams "github.com/Source-Protocol-Cosmos/source/v3/app/params"
...
// SetupWithGenesisValSet initializes a new sourceApp with a validator set and genesis accounts
// that also act as delegators. For simplicity, each validator is bonded with a delegation
// of one consensus engine unit in the default token of the SourceApp from first genesis
// account. A Nop logger is set in SourceApp.
func SetupWithGenesisValSet(t *testing.T, valSet *tmtypes.ValidatorSet, genAccs []authtypes.GenesisAccount, balances ...banktypes.Balance) *App {
	...
	sourceApp, genesisState := setup(true, 5)
	genesisState = genesisStateWithValSet(t, sourceApp, genesisState, valSet, genAccs, balances...)
	...
	sourceApp.Commit()
	sourceApp.BeginBlock(abci.RequestBeginBlock{Header: tmproto.Header{
		Height:             sourceApp.LastBlockHeight() + 1,
		AppHash:            sourceApp.LastCommitID().Hash,
