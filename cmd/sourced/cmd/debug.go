...
// get cmd to convert any bech32 address to a source prefix.
func ConvertBech32Cmd() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "bech32-convert [bech32 string]",
		Short: "Convert any bech32 string to the source prefix",
		Long: `Convert any bech32 string to the source prefix
Especially useful for converting cosmos addresses to source addresses
Example:
	sourced bech32-convert source1ey69r37gfxvxg62sh4r0ktpuc46pzjrm5cxnjg -p osmo
	`,
	...
	cmd.Flags().StringP(flagBech32Prefix, "p", "source", "Bech32 Prefix to encode to")
