...
// from osmosis
// https://github.com/osmosis-labs/osmosis/blob/main/cmd/sourced/cmd/forceprune.go
...
func forceprune() *cobra.Command {
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			cmdr := exec.Command("sourced", "status")
			err = cmdr.Run()
