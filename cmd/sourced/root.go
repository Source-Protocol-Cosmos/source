...
func NewRootCmd() (*cobra.Command, params.EncodingConfig) {
	...
	rootCmd := &cobra.Command{
		Use:   version.AppName,
		Short: "Source Smart Contract Zone",
...
func (ac appCreator) appExport(
	...
	if height != -1 {
		if err := sourceApp.LoadHeight(height); err != nil {
			return servertypes.ExportedApp{}, err
		}
	}

	return sourceApp.ExportAppStateAndValidators(forZeroHeight, jailAllowedAddrs)
}
