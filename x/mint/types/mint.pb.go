...
func init() {
	proto.RegisterType((*Minter)(nil), "source.mint.Minter")
	proto.RegisterType((*Params)(nil), "source.mint.Params")
}

func init() { proto.RegisterFile("source/mint/mint.proto", fileDescriptor_e0bccce3b583aa44) }
