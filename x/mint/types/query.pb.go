...
// source: source/mint/query.proto
...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "source.mint.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "source.mint.QueryParamsResponse")
	proto.RegisterType((*QueryInflationRequest)(nil), "source.mint.QueryInflationRequest")
	proto.RegisterType((*QueryInflationResponse)(nil), "source.mint.QueryInflationResponse")
	proto.RegisterType((*QueryAnnualProvisionsRequest)(nil), "source.mint.QueryAnnualProvisionsRequest")
	proto.RegisterType((*QueryAnnualProvisionsResponse)(nil), "source.mint.QueryAnnualProvisionsResponse")
}

func init() { proto.RegisterFile("source/mint/query.proto", fileDescriptor_a6f0d4f2a25816bd) }
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/source.mint.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) Inflation(ctx context.Context, in *QueryInflationRequest, opts ...grpc.CallOption) (*QueryInflationResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/source.mint.Query/Inflation", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) AnnualProvisions(ctx context.Context, in *QueryAnnualProvisionsRequest, opts ...grpc.CallOption) (*QueryAnnualProvisionsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/source.mint.Query/AnnualProvisions", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/source.mint.Query/Params",
	}
...
func _Query_Inflation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/source.mint.Query/Inflation",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_AnnualProvisions_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/source.mint.Query/AnnualProvisions",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "source/mint/query.proto",
}
